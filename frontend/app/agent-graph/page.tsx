      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        {analysis ? (
          ...
          <div className="mx-auto max-w-2xl rounded-[36px] border border-slate-200 bg-white p-10 text-center shadow-[0_30px_80px_rgba(148,163,184,0.12)]">
            <h1 className="text-4xl font-semibold tracking-[-0.04em] text-slate-950">No graph data yet</h1>
            <p className="mt-4 text-base leading-8 text-slate-600">
              Run a symptom check from the main experience first. The agent graph will appear here once the backend returns an execution trace.
            </p>
            <div className="mt-8">
              <Button asChild>
